...
export class AppUiCustomizationService {
  ...
  getAppModuleBodyClass(): string {
    ...
    let cssClass = 'page-' + this._theme.baseSettings.layout.layoutType + ' subheader-enabled aside-left-offcanvas';
    ...
    if (this._theme.baseSettings.menu.position === 'left') {
      ...
      cssClass += ' subheader-' + this._theme.baseSettings.subHeader.subheaderStyle;
  ...
  getTopBarMenuContainerClass(): string {
    let menuCssClass =
      'header-bottom header-menu-skin-' + this._theme.baseSettings.menu.asideSkin + ' container container--full-height container-responsive';
