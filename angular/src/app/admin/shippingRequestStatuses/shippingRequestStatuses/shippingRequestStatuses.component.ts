...
export class ShippingRequestStatusesComponent extends AppComponentBase {
    ...
    @ViewChild('createOrEditShippingRequestStatusModal', { static: true }) createOrEditShippingRequestStatusModal: CreateOrEditShippingRequestStatusModalComponent;
    ...
    getShippingRequestStatuses(event?: LazyLoadEvent) {
        ...
        this._shippingRequestStatusesServiceProxy.getAll(
            this.filterText,
    ...
    deleteShippingRequestStatus(shippingRequestStatus: ShippingRequestStatusDto): void {
        this.message.confirm(
            ...
            (isConfirmed) => {
                if (isConfirmed) {
                    this._shippingRequestStatusesServiceProxy.delete(shippingRequestStatus.id)
                        .subscribe(() => {
                            this.reloadPage();
