...
export class TermAndConditionTranslationsComponent extends AppComponentBase {
    ...
    @ViewChild('createOrEditTermAndConditionTranslationModal', { static: true }) createOrEditTermAndConditionTranslationModal: CreateOrEditTermAndConditionTranslationModalComponent;
    @ViewChild('viewTermAndConditionTranslationModalComponent', { static: true }) viewTermAndConditionTranslationModal: ViewTermAndConditionTranslationModalComponent;   
    ...
    getTermAndConditionTranslations(event?: LazyLoadEvent) {
        ...
        this._termAndConditionTranslationsServiceProxy.getAll(
            this.filterText,
            this.languageFilter,
    ...
    deleteTermAndConditionTranslation(termAndConditionTranslation: TermAndConditionTranslationDto): void {
        this.message.confirm(
            ...
            (isConfirmed) => {
                if (isConfirmed) {
                    this._termAndConditionTranslationsServiceProxy.delete(termAndConditionTranslation.id)
                        .subscribe(() => {
                            this.reloadPage();
