...
export class TruckStatusesTranslationsComponent extends AppComponentBase {
    ...
    @ViewChild('createOrEditTruckStatusesTranslationModal', { static: true }) createOrEditTruckStatusesTranslationModal: CreateOrEditTruckStatusesTranslationModalComponent;
    @ViewChild('viewTruckStatusesTranslationModalComponent', { static: true }) viewTruckStatusesTranslationModal: ViewTruckStatusesTranslationModalComponent;   
    ...
    getTruckStatusesTranslations(event?: LazyLoadEvent) {
        ...
        this._truckStatusesTranslationsServiceProxy.getAll(
            this.filterText,
    ...
    deleteTruckStatusesTranslation(truckStatusesTranslation: TruckStatusesTranslationDto): void {
        this.message.confirm(
            ...
            (isConfirmed) => {
                if (isConfirmed) {
                    this._truckStatusesTranslationsServiceProxy.delete(truckStatusesTranslation.id)
                        .subscribe(() => {
                            this.reloadPage();
