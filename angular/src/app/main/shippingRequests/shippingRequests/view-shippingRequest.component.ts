...
import { GetShippingRequestForViewDto, ShippingRequestDto, ShippingRequestsServiceProxy } from '@shared/service-proxies/service-proxies';
...
export class ViewShippingRequestComponent extends AppComponentBase implements OnInit {
  ...
  constructor(injector: Injector, private _activatedRoute: ActivatedRoute, private _shippingRequestsServiceProxy: ShippingRequestsServiceProxy) {
    super(injector);
