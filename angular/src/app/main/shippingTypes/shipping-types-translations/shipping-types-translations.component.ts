...
@Component({
  selector: 'app-shipping-types-translations',
  templateUrl: './shipping-types-translations.component.html',
  styleUrls: ['./shipping-types-translations.component.css'],
})
export class ShippingTypesTranslationsComponent extends AppComponentBase implements OnInit {
  dataSource: any = {};
  @Input() CoreId: any;

  constructor(injector: Injector, private _serviceProxy: ShippingTypesServiceProxy) {
    super(injector);
  }
