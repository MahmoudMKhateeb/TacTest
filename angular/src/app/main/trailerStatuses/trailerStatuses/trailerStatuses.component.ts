...
export class TrailerStatusesComponent extends AppComponentBase {
    ...
    getTrailerStatuses(event?: LazyLoadEvent) {
        ...
        this._trailerStatusesServiceProxy.getAll(
            this.filterText,
    ...
    deleteTrailerStatus(trailerStatus: TrailerStatusDto): void {
        this.message.confirm(
            ...
            (isConfirmed) => {
                if (isConfirmed) {
                    this._trailerStatusesServiceProxy.delete(trailerStatus.id)
                        .subscribe(() => {
                            this.reloadPage();
    ...
    exportToExcel(): void {
        this._trailerStatusesServiceProxy.getTrailerStatusesToExcel(
        this.filterText,
            this.displayNameFilter,
        )
        .subscribe(result => {
