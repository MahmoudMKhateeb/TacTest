...
@Component({
  templateUrl: './invoices-dynamic-items-modal.component.html',
  // styleUrls: ['/assets/custom/css/model.scss'],

  selector: 'invoices-dynamic-items-modal',
  animations: [appModuleAnimation()],
})
export class DynamicInvoiceItemsDetailsComponent extends AppComponentBase {
