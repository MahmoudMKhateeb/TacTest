...
export class CountriesTranslationsComponent extends AppComponentBase {
    ...
    @ViewChild('createOrEditCountriesTranslationModal', { static: true }) createOrEditCountriesTranslationModal: CreateOrEditCountriesTranslationModalComponent;
    ...
    getCountriesTranslations(event?: LazyLoadEvent) {
        ...
        this._countriesTranslationsServiceProxy.getAll(
            this.filterText,
    ...
    deleteCountriesTranslation(countriesTranslation: CountriesTranslationDto): void {
        this.message.confirm(
            ...
            (isConfirmed) => {
                if (isConfirmed) {
                    this._countriesTranslationsServiceProxy.delete(countriesTranslation.id)
                        .subscribe(() => {
                            this.reloadPage();
