...
export class TruckCapacitiesTranslationsComponent extends AppComponentBase {
  @ViewChild('createOrEditTruckCapacitiesTranslationModal', { static: true })
  createOrEditTruckCapacitiesTranslationModal: CreateOrEditTruckCapacitiesTranslationModalComponent;
  @ViewChild('viewTruckCapacitiesTranslationModalComponent', { static: true })
  viewTruckCapacitiesTranslationModal: ViewTruckCapacitiesTranslationModalComponent;
  ...
  getTruckCapacitiesTranslations(event?: LazyLoadEvent) {
    ...
    this._truckCapacitiesTranslationsServiceProxy
      .getAll(
        this.filterText,
  ...
  deleteTruckCapacitiesTranslation(truckCapacitiesTranslation: TruckCapacitiesTranslationDto): void {
    this.message.confirm('', this.l('AreYouSure'), (isConfirmed) => {
      if (isConfirmed) {
        this._truckCapacitiesTranslationsServiceProxy.delete(truckCapacitiesTranslation.id).subscribe(() => {
          this.reloadPage();
