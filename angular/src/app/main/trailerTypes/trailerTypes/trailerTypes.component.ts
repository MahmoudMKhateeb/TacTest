...
export class TrailerTypesComponent extends AppComponentBase {
  ...
  deleteTrailerType(trailerType: TrailerTypeDto): void {
    this.message.confirm('', this.l('AreYouSure'), (isConfirmed) => {
      if (isConfirmed) {
        this._trailerTypesServiceProxy.delete(trailerType.id).subscribe(() => {
          this.reloadPage();
  ...
  exportToExcel(): void {
    this._trailerTypesServiceProxy.getTrailerTypesToExcel(this.filterText, this.displayNameFilter).subscribe((result) => {
