...
@Component({
    selector: 'viewNationalityTranslationModal',
    templateUrl: './view-nationalityTranslation-modal.component.html'
})
export class ViewNationalityTranslationModalComponent extends AppComponentBase {
