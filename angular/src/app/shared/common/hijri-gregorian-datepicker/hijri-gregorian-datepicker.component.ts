...
import { CreateOrEditDocumentFileDto } from '@shared/service-proxies/service-proxies';
const momentHijri = moment_;

@Component({
  selector: 'hijri-gregorian-datepicker-test',
...
export class HijriGregorianDatepickerComponent implements OnInit {
  ...
  hijriClick() {
    ...
    this.selectedDateType = DateType.Hijri;
    console.log('hijriClick selectedDate', this.selectedDate);
    //to hijri
