...
import {
  ...
  CreateDriverRatingByReceiverDto,
...
export class RatingPageComponent extends AppComponentBase implements OnInit {
  ...
  onSubmit() {
    this.saving = true;
    this.rateDto.createDriverRatingByReceiverInput = new CreateDriverRatingByReceiverDto();
    ...
    this.rateDto.createDriverRatingByReceiverInput.rate = this.rate2;

    this.rateDto.createDeliveryExpRateByReceiverInput.code = this.code;
    this.rateDto.createDriverRatingByReceiverInput.code = this.code;

    this.rateDto.createDeliveryExpRateByReceiverInput.note = this.note;
    this.rateDto.createDriverRatingByReceiverInput.note = this.note;
