...
using TACHYON.DynamicEntityParameters;
...
{
    [DependsOn(
        typeof(TACHYONCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class TACHYONCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            TACHYONLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, TACHYONMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(TACHYONCoreModule).GetAssembly());
        }
