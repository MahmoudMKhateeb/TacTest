        ...
        private IEnumerable<SettingDefinition> GetHostSettings()
        {
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.BayanIntegration.Url,
                    GetFromAppSettings(AppSettings.BayanIntegration.Url, "https://bayan-stg.api.elm.sa/api/v1/freight-forwarder/"),
                    isVisibleToClients: true,
                    scopes: SettingScopes.Application),
                new SettingDefinition(AppSettings.BayanIntegration.AppId,
                    GetFromAppSettings(AppSettings.BayanIntegration.AppId, "bb885d7a"), isVisibleToClients: true,
                    scopes: SettingScopes.Application),
                new SettingDefinition(AppSettings.BayanIntegration.AppKey,
                    GetFromAppSettings(AppSettings.BayanIntegration.AppKey, "a0dd5f039a8b2ee9cba1a5e47b67b88f"),
                    isVisibleToClients: true,
                    scopes: SettingScopes.Application),
                new SettingDefinition(AppSettings.BayanIntegration.ClientId,
                    GetFromAppSettings(AppSettings.BayanIntegration.ClientId, "1000000062"),
                    isVisibleToClients: true,
                    scopes: SettingScopes.Application),
