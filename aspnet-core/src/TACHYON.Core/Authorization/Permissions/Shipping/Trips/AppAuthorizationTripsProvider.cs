...
namespace TACHYON.Authorization.Permissions.Shipping.Trips
{
    public class AppAuthorizationTripsProvider : AppAuthorizationBaseProvider
    {
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            var shippingRequestTrips = pages.CreateChildPermission(AppPermissions.Pages_ShippingRequestTrips, L("ShippingRequests"));
            ...
            shippingRequestTrips.CreateChildPermission(AppPermissions.Pages_ShippingRequestTrips_Cancel, L("ShippingRequestTrips_Cancel"), multiTenancySides: MultiTenancySides.Tenant);
