...
namespace TACHYON.Rating
{
    ...
    public class RatingLog : Entity<long>, IHasCreationTime, IEquatable<RatingLog>
    {
        ...
        [ForeignKey("DriverId")] public User DriverFk { get; set; }
        public int? ShipperId { get; set; }
        [ForeignKey("ShipperId")] public Tenant ShipperFk { get; set; }
        public int? CarrierId { get; set; }
        [ForeignKey("CarrierId")] public Tenant CarrierFk { get; set; }
        public long? PointId { get; set; }
        [ForeignKey("PointId")] public RoutPoint RoutePointFk { get; set; }
        public int? TripId { get; set; }
        [ForeignKey("TripId")] public ShippingRequestTrip TripFk { get; set; }
