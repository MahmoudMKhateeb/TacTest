...
{
    public class UpdateWaybillJob : BackgroundJob<long>, ITransientDependency
    {
        private readonly BayanIntegrationManagerV3 _bayanIntegrationManager3;

        public UpdateWaybillJob(BayanIntegrationManagerV3 bayanIntegrationManager3)
        {
        ...
        public override void Execute(long routPointId)
        {
            ...
            AsyncHelper.RunSync(() => _bayanIntegrationManager3.UpdateWaybill(routPointId));
