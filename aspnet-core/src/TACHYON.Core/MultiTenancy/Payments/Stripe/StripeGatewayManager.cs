...
{
    public class StripeGatewayManager : TACHYONServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "TACHYON";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + TACHYONConsts.Currency;
        }
