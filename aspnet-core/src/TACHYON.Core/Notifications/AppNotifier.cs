...
namespace TACHYON.Notifications
{
    public class AppNotifier : TACHYONDomainServiceBase, IAppNotifier
    {
        ...
        public async Task NotifyShipperWhenTripUpdated(NotifyTripUpdatedInput input)
        {
            ...
            await _notificationPublisher.PublishAsync(AppNotificationNames.NotifyShipperWhenTripUpdated,
        ...
        public async Task NotifyCarrierWhenTripUpdated(NotifyTripUpdatedInput input)
        {
            ...
            await _notificationPublisher.PublishAsync(AppNotificationNames.NotifyCarrierWhenTripUpdated,
                notificationData, userIds: notifiedUsers.ToArray());
        }
            ...
            params UserIdentifier[] drivers)
        {
            var notificationData = new LocalizableMessageNotificationData(
                new LocalizableString(
                    ...
                    TACHYONConsts.LocalizationSourceName)) { ["id"] = tripId };
            await _firebaseNotifier.PushNotification(AppNotificationNames.NotifyCarrierWhenTripUpdated,
        ...
        public async Task NotifyTripUpdated(ShippingRequestTrip trip)
        {
            ...
            {
                ShipperTenantId = shipperTenantId, TripId = trip.Id, WaybillNumber = waybillNo.ToString()
            };
            ...
            else
            {
                ...
                if (trip.AssignedDriverUserId != null && trip.DriverStatus == ShippingRequestTripDriverStatus.Accepted)
        ...
        public async Task NotifyDriverWhenUnassignedTrip(int tripId,
            string waybillNumber,
            params UserIdentifier[] drivers)
        {
            var notificationData = new LocalizableMessageNotificationData(
        ...
        public async Task ShipperReminderToCompleteTrips(long shippingRequestId, UserIdentifier userId)
        {
            ...
            await _firebaseNotifier.PushNotification(AppNotificationNames.ShipperReminderToCompleteTrips,
                notificationData, userId.UserId);
            await _notificationPublisher.PublishAsync(AppNotificationNames.ShipperReminderToCompleteTrips,
                notificationData, userIds: new[] { userId });
        }
