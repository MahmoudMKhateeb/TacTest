...
namespace TACHYON.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : TACHYONAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<TACHYONDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{TACHYONConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{TACHYONConsts.ConnectionStringName}", constring);
        }
