...
namespace TACHYON.Vases
{
    ...
    public class VasPricesAppService : TACHYONAppServiceBase, IVasPricesAppService
    {
        ...
        public VasPricesAppService(IRepository<VasPrice> vasPriceRepository,
            IVasPricesExcelExporter vasPricesExcelExporter,
        ...
        public async Task<GetVasPriceForEditOutput> GetVasPriceForEdit(EntityDto input)
        {
            ...
            var output =
                new GetVasPriceForEditOutput { VasPrice = ObjectMapper.Map<CreateOrEditVasPriceDto>(vasPrice) };
