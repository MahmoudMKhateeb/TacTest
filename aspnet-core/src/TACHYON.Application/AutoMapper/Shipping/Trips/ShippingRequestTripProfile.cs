    ...
    public class ShippingRequestTripProfile : Profile
    {
        public ShippingRequestTripProfile()
        {
            ...
            CreateMap<ShippingRequestTrip, ShippingRequestsTripForViewDto>()
               ...
               .ForMember(dst => dst.RoutePointStatus, opt => opt.MapFrom(src =>  src.Status.GetEnumDescription()))
            ...
            CreateMap<ShippingRequestTrip, CreateOrEditShippingRequestTripDto>()
                ...
                .ForMember(dest => dest.CountryId, opt => opt.MapFrom(src => src.OriginCityFk.CountyId))
                .ForMember(dest => dest.ShippingRequestDestinationCities, opt => opt.MapFrom(src => src.ShippingRequestDestinationCities));
