...
{
    public class SessionAppService : TACHYONAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    CurrencySign = TACHYONConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = TACHYONConsts.AllowTenantsToChangeEmailSettings,
