...
namespace TACHYON.Countries.CountriesTranslations
{
    ...
    public class CountriesTranslationsAppService : TACHYONAppServiceBase, ICountriesTranslationsAppService
    {
        ...
        public CountriesTranslationsAppService(IRepository<CountriesTranslation> countriesTranslationRepository, IRepository<County, int> lookup_countyRepository)
        {
        ...
        public async Task<PagedResultDto<GetCountriesTranslationForViewDto>> GetAll(GetAllCountriesTranslationsInput input)
        {
            ...
            var filteredCountriesTranslations = _countriesTranslationRepository.GetAll()
                        ...
                        .WhereIf(!string.IsNullOrWhiteSpace(input.CountyDisplayNameFilter), e => e.Core != null && e.Core.DisplayName == input.CountyDisplayNameFilter);
        ...
        public async Task<GetCountriesTranslationForViewDto> GetCountriesTranslationForView(int id)
        {
            ...
            var output = new GetCountriesTranslationForViewDto { CountriesTranslation = ObjectMapper.Map<CountriesTranslationDto>(countriesTranslation) };

            if (output.CountriesTranslation.CoreId != null)
            {
                var _lookupCounty = await _lookup_countyRepository.FirstOrDefaultAsync((int)output.CountriesTranslation.CoreId);
        ...
        public async Task<GetCountriesTranslationForEditOutput> GetCountriesTranslationForEdit(EntityDto input)
        {
            ...
            var output = new GetCountriesTranslationForEditOutput { CountriesTranslation = ObjectMapper.Map<CreateOrEditCountriesTranslationDto>(countriesTranslation) };
