...
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : TACHYONAppServiceBase, IDashboardCustomizationAppService
    {
        ...
        public async Task<AddNewPageOutput> AddNewPage(AddNewPageInput input)
        {
            ...
            var page = new Page { Name = input.Name, Widgets = new List<Widget>(), };
