...
namespace TACHYON.Shipping.ShippingRequestStatuses
{
    ...
    public class ShippingRequestStatusesAppService : TACHYONAppServiceBase, IShippingRequestStatusesAppService
    {
        ...
        public async Task<PagedResultDto<GetShippingRequestStatusForViewDto>> GetAll(
            GetAllShippingRequestStatusesInput input)
        {
            ...
            var shippingRequestStatuses = from o in pagedAndFilteredShippingRequestStatuses
                ...
                {
                    ShippingRequestStatus = new ShippingRequestStatusDto { DisplayName = o.DisplayName, Id = o.Id }
                };
        ...
        public async Task<GetShippingRequestStatusForViewDto> GetShippingRequestStatusForView(int id)
        {
            ...
            var output = new GetShippingRequestStatusForViewDto
            {
                ShippingRequestStatus = ObjectMapper.Map<ShippingRequestStatusDto>(shippingRequestStatus)
            };
        ...
        public async Task<GetShippingRequestStatusForEditOutput> GetShippingRequestStatusForEdit(EntityDto input)
        {
            ...
            var output = new GetShippingRequestStatusForEditOutput
            {
                ShippingRequestStatus =
                    ObjectMapper.Map<CreateOrEditShippingRequestStatusDto>(shippingRequestStatus)
            };
