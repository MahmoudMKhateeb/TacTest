...
namespace TACHYON.Shipping.Accidents
{
    ...
    public class ShippingRequestReasonAccidentAppService : TACHYONAppServiceBase,
        IShippingRequestReasonAccidentAppService
    {
        ...
        public ShippingRequestReasonAccidentAppService(
            IRepository<ShippingRequestReasonAccident> ShippingRequestCauseAccidentRepository,
        ...
        {
            var ReasonAccident = await _ShippingRequestReasonAccidentRepository.GetAllIncluding(x => x.Translations)
