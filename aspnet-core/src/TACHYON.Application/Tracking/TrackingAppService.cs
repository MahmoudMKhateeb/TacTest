...
namespace TACHYON.Tracking
{
    ...
    public class TrackingAppService : TACHYONAppServiceBase, ITrackingAppService
    {
        ...
        public TrackingAppService(ShippingRequestPointWorkFlowProvider workFlowProvider,
        ...
        private TrackingListDto GetMap(ShippingRequestTrip trip)
        {
            ...
            if (trip.AssignedTruckFk != null)
                dto.TruckType = ObjectMapper.Map<TrucksTypeDto>(trip.AssignedTruckFk.TrucksTypeFk)
            ...
            {
                dto.Reason =
                    ObjectMapper.Map<ShippingRequestTripRejectReasonListDto>(trip.ShippingRequestTripRejectReason)
                        .Name ?? "";
            }
        ...
        {
            return _ShippingRequestTripRepository.GetAll().Any(x =>
