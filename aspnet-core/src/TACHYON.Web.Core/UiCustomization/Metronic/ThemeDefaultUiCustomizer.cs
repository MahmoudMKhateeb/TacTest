    ...
    public class ThemeDefaultUiCustomizer : UiThemeCustomizerBase, IUiCustomizer
    {
        ...
        public async Task<UiCustomizationSettingsDto> GetUiSettings()
        {
            var settings = new UiCustomizationSettingsDto
            {
                BaseSettings = new ThemeSettingsDto
                {
                    ...
                    SubHeader =
                        new ThemeSubHeaderSettingsDto
                        {
                            FixedSubHeader =
                                await GetSettingValueAsync<bool>(AppSettings.UiManagement.SubHeader.Fixed),
                            SubheaderStyle =
                                await GetSettingValueAsync(AppSettings.UiManagement.SubHeader.Style)
                        },
                    Menu = new ThemeMenuSettingsDto
                    {
                        AsideSkin =
                            await GetSettingValueAsync(AppSettings.UiManagement.LeftAside.AsideSkin),
                        FixedAside =
                            await GetSettingValueAsync<bool>(AppSettings.UiManagement.LeftAside.FixedAside),
                        AllowAsideMinimizing =
                            await GetSettingValueAsync<bool>(AppSettings.UiManagement.LeftAside
                                .AllowAsideMinimizing),
                        DefaultMinimizedAside =
                            await GetSettingValueAsync<bool>(AppSettings.UiManagement.LeftAside
                                .DefaultMinimizedAside),
                        SubmenuToggle =
                            await GetSettingValueAsync(AppSettings.UiManagement.LeftAside.SubmenuToggle),
                        SearchActive =
                    ...
                    {
                        FixedFooter =
                            await GetSettingValueAsync<bool>(AppSettings.UiManagement.Footer.FixedFooter)
                    }
                }
            };
        ...
        public async Task<ThemeSettingsDto> GetHostUiManagementSettings()
        {
            ...
            return new ThemeSettingsDto
            {
                    ...
                    new ThemeHeaderSettingsDto
                    {
                        ...
                        MobileFixedHeader =
                            await GetSettingValueForApplicationAsync<bool>(AppSettings.UiManagement.Header
                                .MobileFixedHeader),
                        HeaderSkin =
                            await GetSettingValueForApplicationAsync(AppSettings.UiManagement.Header.Skin)
                    },
                SubHeader =
                    new ThemeSubHeaderSettingsDto
                    {
                        FixedSubHeader =
                            await GetSettingValueForApplicationAsync<bool>(AppSettings.UiManagement.SubHeader
                                .Fixed),
                        SubheaderStyle =
                            await GetSettingValueForApplicationAsync(AppSettings.UiManagement.SubHeader.Style)
                    },
                Menu = new ThemeMenuSettingsDto
                {
                    AsideSkin =
                    ...
                    DefaultMinimizedAside =
                        await GetSettingValueForApplicationAsync<bool>(AppSettings.UiManagement.LeftAside
                            .DefaultMinimizedAside),
                    SubmenuToggle =
                        await GetSettingValueForApplicationAsync(AppSettings.UiManagement.LeftAside
                            .SubmenuToggle),
                    SearchActive =
                ...
                {
                    FixedFooter =
                        await GetSettingValueForApplicationAsync<bool>(AppSettings.UiManagement.Footer
                            .FixedFooter)
                }
            };
        }
            ...
            return new ThemeSettingsDto
            {
                ...
                Header =
                    new ThemeHeaderSettingsDto
                    {
                        ...
                        HeaderSkin = await GetSettingValueForTenantAsync(AppSettings.UiManagement.Header.Skin,
                            tenantId)
                    },
                SubHeader =
                    new ThemeSubHeaderSettingsDto
                    {
                        FixedSubHeader =
                            await GetSettingValueForTenantAsync<bool>(AppSettings.UiManagement.SubHeader.Fixed,
                                tenantId),
                        SubheaderStyle =
                            await GetSettingValueForTenantAsync(AppSettings.UiManagement.SubHeader.Style,
                                tenantId)
                    },
                Menu = new ThemeMenuSettingsDto
                {
                    AsideSkin =
                        await GetSettingValueForTenantAsync(AppSettings.UiManagement.LeftAside.AsideSkin,
                            tenantId),
                    FixedAside =
                    ...
                    SubmenuToggle =
                        await GetSettingValueForTenantAsync(AppSettings.UiManagement.LeftAside.SubmenuToggle,
                            tenantId),
                    SearchActive =
                        await GetSettingValueForApplicationAsync<bool>(AppSettings.UiManagement.SearchActive)
                },
                ...
                {
                    FixedFooter =
                        await GetSettingValueForTenantAsync<bool>(AppSettings.UiManagement.Footer.FixedFooter,
                            tenantId)
                }
            };
        }
