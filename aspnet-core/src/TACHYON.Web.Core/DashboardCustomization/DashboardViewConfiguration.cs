...
namespace TACHYON.Web.DashboardCustomization
{
    public class DashboardViewConfiguration
    {
        ...
        public DashboardViewConfiguration()
        {
            ...
            WidgetViewDefinitions.Add(TACHYONDashboardCustomizationConsts.Widgets.Tenant.DailySales,
            ...
            WidgetViewDefinitions.Add(TACHYONDashboardCustomizationConsts.Widgets.Tenant.GeneralStats,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(TACHYONDashboardCustomizationConsts.Widgets.Tenant.ProfitShare,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(TACHYONDashboardCustomizationConsts.Widgets.Tenant.RegionalStats,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(TACHYONDashboardCustomizationConsts.Widgets.Tenant.SalesSummary,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(TACHYONDashboardCustomizationConsts.Widgets.Tenant.TopStats,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(TACHYONDashboardCustomizationConsts.Widgets.Host.IncomeStatistics,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(TACHYONDashboardCustomizationConsts.Widgets.Host.TopStats,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(TACHYONDashboardCustomizationConsts.Widgets.Host.EditionStatistics,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(TACHYONDashboardCustomizationConsts.Widgets.Host.SubscriptionExpiringTenants,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(TACHYONDashboardCustomizationConsts.Widgets.Host.RecentTenants,
                new WidgetViewDefinition(
