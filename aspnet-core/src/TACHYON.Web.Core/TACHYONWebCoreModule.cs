...
using TACHYON.Web.Configuration;
using TACHYON.Web.DashboardCustomization;
...
namespace TACHYON.Web
{
    ...
    public class TACHYONWebCoreModule : AbpModule
    {
        ...
        public TACHYONWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(TACHYONApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(TACHYONWebCoreModule).GetAssembly());
        }
