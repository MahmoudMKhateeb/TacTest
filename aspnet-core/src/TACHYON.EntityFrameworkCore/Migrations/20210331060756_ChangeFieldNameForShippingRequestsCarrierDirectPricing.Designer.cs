...
namespace TACHYON.Migrations
{
    ...
    [Migration("20210331060756_ChangeFieldNameForShippingRequestsCarrierDirectPricing")]
    partial class ChangeFieldNameForShippingRequestsCarrierDirectPricing
    {
            ...
            modelBuilder.Entity("TACHYON.Shipping.ShippingRequests.TachyonDealer.ShippingRequestsCarrierDirectPricing", b =>
                {
                    ...
                    b.HasOne("TACHYON.MultiTenancy.Tenant", "Tenants")
                        .WithMany()
                        .HasForeignKey("TenantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
