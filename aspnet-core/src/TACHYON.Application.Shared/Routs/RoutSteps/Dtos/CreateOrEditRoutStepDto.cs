...
namespace TACHYON.Routs.RoutSteps.Dtos
{
    public class CreateOrEditRoutStepDto : EntityDto<long?>
    {
        ...
        [Required] public CreateOrEditRoutPointDto CreateOrEditSourceRoutPointInputDto { get; set; }
        [Required] public CreateOrEditRoutPointDto CreateOrEditDestinationRoutPointInputDto { get; set; }
    }
}