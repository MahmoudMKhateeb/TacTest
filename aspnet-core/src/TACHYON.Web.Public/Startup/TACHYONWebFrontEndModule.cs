...
namespace TACHYON.Web.Public.Startup
{
    [DependsOn(
        typeof(TACHYONWebCoreModule)
    )]
    public class TACHYONWebFrontEndModule : AbpModule
    {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(TACHYONWebFrontEndModule).GetAssembly());
        }
    }
}
