...
using TACHYON.MultiTenancy.HostDashboard;
...
namespace TACHYON.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(TACHYONDbContext context, SubscriptionPayment subscriptionPayment)
        {
