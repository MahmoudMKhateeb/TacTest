...
namespace TACHYON.Tests.Auditing
{
    ...
    public class NamespaceStripper_Tests : AppTestBase
    {
        ...
        [Theory]
        [InlineData(
            "TACHYON.Auditing.GenericEntityService`1[[TACHYON.Storage.BinaryObject, TACHYON.Core, Version=1.10.1.0, Culture=neutral, PublicKeyToken=null]]",
        ...
        [InlineData(
            "TACHYON.Auditing.XEntityService`1[TACHYON.Auditing.AService`5[[TACHYON.Storage.BinaryObject, TACHYON.Core, Version=1.10.1.0, Culture=neutral, PublicKeyToken=null],[TACHYON.Storage.TestObject, TACHYON.Core, Version=1.10.1.0, Culture=neutral, PublicKeyToken=null],]]",
